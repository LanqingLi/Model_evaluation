...
class Predict(object):
    def __init__(self, model_prefix=os.path.join(config.model_dir, config.validating.model_name),
                 epoch=config.validating.epoch, gpus=config.gpu, num_classes=config.num_cls,
        ...
        self.batch_size = config.validating.batch_size
        self.mod = None
